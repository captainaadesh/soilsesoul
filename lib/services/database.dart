...
import 'package:firebase_auth_demo_flutter/services/api_path.dart';
...
abstract class Database {
  ...
  Future<void> setAvatarReference(AvatarReference avatarReference);
...
class FirestoreDatabase implements Database {
  ...
  Stream<AvatarReference> avatarReferenceStream() => _service.documentStream(
    path: APIPath.avatar(uid),
    builder: (data, documentId) => AvatarReference.fromMap(data),
  );
